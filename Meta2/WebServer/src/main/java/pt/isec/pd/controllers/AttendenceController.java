...
public class AttendenceController {
    ...
    public ResponseEntity generateCode(Authentication authentication,
                                   @PathVariable("name") String name, @PathVariable("time") String time) throws UnsupportedEncodingException {
        ...
        if (DatabaseManager.getInstance().generateCode(evt)) {
            System.out.println("[*] Code "+evt.getAttend_code()+"generated by " + auth_username);
            return ResponseEntity.ok(evt.getAttend_code());
        } else {
